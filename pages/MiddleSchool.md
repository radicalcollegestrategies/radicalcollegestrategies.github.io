...
---
<sectionpd>
<h3 style="margin:10px;">Grades K-7 STEM students (U.S. only):</h3>
<div class="license" style="text-align:center;font-size:14px;">
    <a style="color:black" href="/HighSchool">High School Students: Click here</a>
</div> 

<h2 style="margin-top:15px;margin-bottom:0px;color:black">3 ways <div style="display:inline;font-family:Courier New;font-size:44px;"><b>I</b></div> help middle school students <br>gain early advantage in Competitions</h2> 
<h3 style="margin-top:5px;color:black">Math, Robotics and Coding</h3>
...
<sectionpd>
<h2 style="margin-top:15px;margin-bottom:0px;color:black">3 ways <div style="display:inline;font-family:Courier New;font-size:44px;"><b>I</b></div> help undecided students gain clarity into what subects to pursue in High School</h2> 
